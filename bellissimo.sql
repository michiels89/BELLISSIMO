...
--
-- Host: 127.0.0.1
-- Gegenereerd op: 08 mrt 2018 om 15:51
...
CREATE TABLE `treatments` (
  ...
  `duurTijd` int(5) NOT NULL,
  `omschrijving` text CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
--
-- Gegevens worden geëxporteerd voor tabel `treatments`
--
INSERT INTO `treatments` (`id`, `naam`, `prijs`, `duurTijd`, `omschrijving`) VALUES
(1, 'Manicure', 15, 60, 'Bij een manicure worden de nagelriemen achteruit geduwd en verzorgd, de dode huidcellen verwijderd en nagels in vorm gevijld. Daarna kan je genieten van een ontspannende handmassage. Als afwerking worden de nagels gelakt met een doorzichtige nagellak.'),
(2, 'Gellak: full color', 28, 75, 'Deze wordt op de natuurlijke nagel aangebracht. De textuur van gellak is iets dikker dan een gewone nagellak, blijft een 3 tal weken zitten en geeft de nagels meer stevigheid. Na het aanbrengen wordt deze uitgehard onder een LED lamp. Full color: keuze uit verschillende kleuren.'),
(3, 'Gellak : french', 30, 90, 'Deze wordt op de natuurlijke nagel aangebracht. De textuur van gellak is iets dikker dan een gewone nagellak, blijft een 3 tal weken zitten en geeft de nagels meer stevigheid. Na het aanbrengen wordt deze uitgehard onder een LED lamp. French : met een wit randje.'),
(4, 'lol', 35, 100, 'qsdqd qd q qsd dfg dfdg'),
(5, 'sfsdf', 45, 105, 'sdfsd hfghfgh');
-- --------------------------------------------------------
--
